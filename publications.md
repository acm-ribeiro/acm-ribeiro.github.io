...
<div class="pub-row">
  <div class="col-sm-9" style="position: relative; padding-right: 15px; padding-left: 20px;">
    <div class="title">
      <a href="https://arxiv.org/abs/2604.08633">Systematic API Testing Through Model Checking and Executable Contracts</a>
    </div>
    <div class="author">
    ...
    <div class="links">
      <a href="https://arxiv.org/pdf/2604.08633" class="btn btn-sm z-depth-0" role="button" target="_blank" style="font-size:12px;">Pre-print</a>
    </div>
  </div>
</div>
</li>
